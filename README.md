...
| [7](#ram-allocation) | RAM | Less than 3 GB without Medal boosts (varies by software/version) | Up to 16 GB |
...
| [10](#discord-bot) | Discord bot | No public Discord bot; requires visiting the website to access the server | Public Discord bot to start/stop/restart servers, get status, and more |
...
| [15](#file-downloads) | File downloads | Only certain files (worlds, configs, Bedrock addons, etc.) | Any files (`Ctrl + A` to select all) |
| [16](#server-creation-limit-per-account) | Servers per account | Create up to 3 servers | Create up to 10 servers |
| [17](#server-regions) | Server regions | Central Europe only | Central Europe and North America |
...
| [20](#modpacks) | Modpacks | Only preloaded modpacks | Can upload custom modpacks |
| [21](#preloaded-modpacks) | Preloaded modpacks | Fewer available | More available |
| [22](#modpack-modification) | Modpack modification | Cannot modify mod collection or configs | Possible with modpack overrides |
| [23](#modpack-versions) | Modpack versions | Only latest version available | Can use specific versions by uploading as custom server software |
| [24](#monetization) | Monetization | Not allowed | Allowed |
| [25](#offline-waiting-lobby) | Offline waiting lobby | Cannot be disabled | Configurable |
| [26](#player-idle-timeout) | Player idle timeout | Limited; cannot be disabled | Not limited |
| [27](#server-render--view-distance) | Server render / view distance | Limited | Not limited |
| [28](#server-advertising) | Advertising | Aternos Discord | Aternos and exaroton Discord |
