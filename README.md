...
|---|--------|---------|----------|
| [1](#1-public-api) | Public API | Doesn't provide a public API | Provides a public API |
| [2](#2-custom-startup-arguments) | Custom startup arguments | Not possible | Supported |
| [3](#3-performance) | Performance | Lower performance | Better performance |
| [4](#4-server-loading--saving-speed) | Loading / saving speed | Slower | Faster |
| [5](#5-ads) | Ads | Funded by ads; many ads on the website | Paid service; ad-free |
| [6](#6-startup-queue) | Startup queue | May be lined up in a queue when starting the server | No queue |
| [7](#7-ram-allocation) | RAM | Less than 3 GB without Medal boosts (varies by software/version) | Up to 16 GB |
| [8](#8-world-upload-size-limit) | World upload size limit | 1 GB | 3 GB |
| [9](#9-server-storage-limit-compressed) | Server storage limit (compressed) | 4 GB | 10 GB |
| [10](#10-discord-bot) | Discord bot | No public Discord bot; requires visiting the website to access the server | Public Discord bot to start/stop/restart servers, get status, and more |
| [11](#11-autostart) | Autostart | Not available | Available |
| [12](#12-autostop) | Autostop | Always enabled to save resources | Configurable; can be enabled to save credits |
| [13](#13-custom-plugins--mods) | Custom plugins / mods | Not possible as some allow automatic shutdown circumvention | Any plugins / mods allowed |
| [14](#14-paid-plugins--mods) | Paid plugins / mods | Not possible | Allowed |
| [15](#15-file-downloads) | File downloads | Only certain files (worlds, configs, Bedrock addons, etc.) | Any files (`Ctrl + A` to select all) |
| [16](#16-server-creation-limit-per-account) | Servers per account | Create up to 3 servers | Create up to 10 servers |
| [17](#17-server-regions) | Server regions | Central Europe only | Central Europe and North America |
| [18](#18-server-networks) | Server networks | Not supported | Supported |
| [19](#19-custom-server-software) | Custom server software | Not supported | Supported |
| [20](#20-modpacks) | Modpacks | Only preloaded modpacks | Can upload custom modpacks |
| [21](#21-preloaded-modpacks) | Preloaded modpacks | Fewer available | More available |
| [22](#22-modpack-modification) | Modpack modification | Cannot modify mod collection or configs | Possible with modpack overrides |
| [23](#23-modpack-versions) | Modpack versions | Only latest version available | Can use specific versions by uploading as custom server software |
| [24](#24-monetization) | Monetization | Not allowed | Allowed |
| [25](#25-offline-waiting-lobby) | Offline waiting lobby | Cannot be disabled | Configurable |
| [26](#26-player-idle-timeout) | Player idle timeout | Limited; cannot be disabled | Not limited |
| [27](#27-server-render--view-distance) | Server render / view distance | Limited | Not limited |
| [28](#28-server-advertising) | Advertising | Aternos Discord | Aternos and exaroton Discord |
...
8. **World Upload Size Limit**
   - Aternos: 1 GB
   - exaroton: 3 GB

9. **Server Storage Limit (compressed)**
   - Aternos: 4 GB
   - exaroton: 10 GB
...
10. **Discord Bot**
    ...
    - exaroton provides a public Discord bot to start, stop, restart servers, check status, and more. See [the official guide](https://support.exaroton.com/hc/en-us/articles/360019687777).
...
16. **Server Creation Limit per Account**
...
20. **Modpacks**
    ...
    - exaroton also allows uploading custom modpacks. See [the official guide](https://support.exaroton.com/hc/en-us/articles/360019687717-Uploading-custom-server-software-and-modpacks#:~:text=server%2Dlaunch.jar.-,Modpacks,-Since%20modpacks%20are).

21. **Preloaded Modpacks**
...
26. **Player Idle Timeout**
    - Idle (AFK) players are kicked from the server after a certain time. This cannot be disabled on Aternos and is limited to a maximum of 30 minutes.
    - exaroton does not limit this. It can be configured on [the options page](https://exaroton.com/options) or using the `/setidletimeout <minutes>` command. If set to `0`, the idle timeout is disabled.

27. **Server Render / View Distance**
    - On Aternos, the maximum value is limited to 15 on Paper/Purpur/Bedrock and 10 on other software for performance optimization. [Read more here](https://support.aternos.org/hc/en-us/articles/360032974492). Players can use a mod like [Bobby](https://modrinth.com/mod/bobby) to achieve a greater render distance than the server's.
    - exaroton does not limit this. It can be configured in the [`server.properties`](http://exaroton.com/files/server.properties) file. It is not recommended to set the server render distance higher than 10.

28. **Server Advertising**
    - On Aternos, server advertisements are only allowed in the [Aternos Discord](https://discord.gg/aternos)'s **servers** channel.
    - On exaroton, server advertisements are allowed in both the [Aternos Discord](https://discord.gg/aternos)'s **servers** channel and the [exaroton Discord](http://discord.gg/exaroton)'s **servers** channel.
